package br.dev.gbrl.todolist.task;
...
import br.dev.gbrl.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        UUID userId = (UUID) request.getAttribute(Constants.USER_ID_KEY);
        ...
        return ResponseEntity.status(HttpStatus.CREATED.value()).body(task);
    }
